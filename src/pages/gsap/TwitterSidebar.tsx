...
export default function () {
  useEffect(() => {
    ...
    sidebar.querySelectorAll('button').forEach((button) => {
      ...
      button.addEventListener('pointerleave', (e) => {
        to(button, {
          ...
          '--c-color':
            button.classList.contains('active') || sidebar.animating === button
              ? getVar('--c-active')
              : getVar('--c-default'),
          duration: 0.15,
        })
    ...
    sidebar.querySelectorAll('.home').forEach((button) =>
      wrap(button, () => {
        to(button, {
          keyframes: [
            {
    ...
    sidebar.querySelectorAll('.explore').forEach((button) =>
      wrap(button, () => {
        to(button, {
    ...
    sidebar.querySelectorAll('.notifications').forEach((button) =>
      wrap(button, () => {
        to(button, {
          duration: 1,
          keyframes: [
    ...
    sidebar.querySelectorAll('.messages').forEach((button) =>
      wrap(button, () => {
        to(button, {
          keyframes: [
            {
    ...
    sidebar.querySelectorAll('.bookmark').forEach((button) =>
      wrap(button, () => {
        to(button, {
          '--icon-default-y': '-20px',
          duration: 0.3,
        ...
        to(button.querySelector('.corner'), {
          keyframes: [
            {
              morphSVG:
                'M5.68047 3H11.9995H18.3186C20.7497 3 21.9299 9 19.2215 9H4.77786C2.06991 9 3.24972 3 5.68047 3Z',
              duration: 0.15,
            },
            {
              morphSVG:
                'M4.36835 6C4.36835 6 5.71509 10.7143 12.0001 10.7143C18.2852 10.7143 19.6316 6 19.6316 6C23.6719 6 21.8766 12 19.1829 12H4.81702C2.12365 12 0.327912 6 4.36835 6Z',
              duration: 0.125,
            },
            {
              morphSVG: {
                shape:
                  'M4 20.3665C4.00001 20.8781 4.60713 21.1779 5.04898 20.8845L12 15.95L18.951 20.8845C19.3929 21.1779 20 20.8781 20 20.3664V15L4 14.9999V20.3665Z',
                shapeIndex: 6,
              },
              duration: 0.6,
    ...
    sidebar.querySelectorAll('.lists').forEach((button) =>
      wrap(button, () => {
        to(button, {
          keyframes: [
            {
    ...
    sidebar.querySelectorAll('.profile').forEach((button) =>
      wrap(button, () => {
        to(button, {
          keyframes: [
            {
            ...
            <div>
              <div className="icon">
                <svg viewBox="0 0 24 24">
                  <path
                    className="outline"
                    d="M20.1215 3.68027C20.2477 3.62291 20.3775 3.75271 20.3202 3.87889L15.4927 14.4992C15.2926 14.9394 14.9398 15.2923 14.4996 15.4924L3.87927 20.3198C3.7531 20.3771 3.6233 20.2473 3.68065 20.1212L8.50808 9.50082C8.70818 9.0606 9.06099 8.70779 9.5012 8.50769L20.1215 3.68027Z"
                  />
                  <path
                    className="triangle"
                    d="M14.6722 14.6718L9.32861 9.32822C9.08175 9.08137 9.15745 8.66395 9.47526 8.51949L20.1215 3.68027C20.2477 3.62291 20.3775 3.75271 20.3202 3.87889L15.4809 14.5252C15.3365 14.843 14.9191 14.9187 14.6722 14.6718Z"
                  />
                </svg>
              </div>
              Explore
            ...
            <div>
              <div className="icon">
                <svg viewBox="0 0 24 24">
                  <path
                    className="ring"
                    d="M15.75 17.5H8.24914C8.24914 17.5 8.00047 21.5 12 21.5C15.9995 21.5 15.75 17.5 15.75 17.5Z"
                  />
                  <path
                    className="bell"
                    d="M21 17.5H3C5.07944 15.9703 5.25 11.5 5.5 8.5C5.50037 6.17481 8.67481 3 12 3C15.3252 3 18.5001 6.17481 18.5 8.5C18.75 11.5 18.9206 15.9703 21 17.5Z"
                  />
                </svg>
              </div>
              Notifications
