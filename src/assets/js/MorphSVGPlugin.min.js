...
!(function (t, e) {
      ...
      ? ((s = (function _createPath(t, e) {
        ...
        'rect' === T
          ...
          : ('polyline' !== T && 'polygon' !== T) ||
            ((n =
              'M' +
              (r = (c = (t.getAttribute('points') + '').match(N) || []).shift()) +
              ',' +
              (o = c.shift()) +
              ' L' +
              c.join(',')),
  ...
  function arcToSegment(t, e, n, r, o, i, a, s, h) {
    if (t !== s || e !== h) {
      ...
      for (I = 0; I < U.length; I += 2)
        (P = U[I]), (_ = U[I + 1]), (U[I] = P * G + _ * q + N), (U[I + 1] = P * W + _ * H + z)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < v; e++)
      if (
        ...
        (c = m),
          (g = w),
          ('C' !== p && 'S' !== p) || ((c += m - s[s.length - 4]), (g += w - s[s.length - 3])),
          a || (m = w = 0),
        ...
        if (
          ...
          (n = 7),
          1 < u.length &&
            (u.length < 3 ? ((g = c), (c = d), n--) : ((g = d), (c = u.substr(2)), (n -= 2)),
            (d = u.charAt(1)),
            (u = u.charAt(0))),
          (f = arcToSegment(
            m,
  ...
  function rawPathToString(t) {
    ...
    var e,
      ...
      a = t.length
    for (n = 0; n < a; n++) {
      for (o = t[n], i += 'M' + h(o[0]) + ',' + h(o[1]) + ' C', e = o.length, r = 2; r < e; r++)
        i +=
          h(o[r++]) +
          ',' +
          h(o[r++]) +
  ...
  function T(t) {
    var e,
      ...
      h = s
    for (r = 6; r < o; r += 6)
      i < (e = t[r]) ? (i = e) : e < a && (a = e), s < (n = t[r + 1]) ? (s = n) : n < h && (h = n)
    ...
    for (
      ...
      for (n = (a = t[m]).length, i = 6; i < n; i += 6)
        for (
          ...
          w < (r = ((h = M * s) * h * u + 3 * (l = 1 - h) * (h * p + l * f)) * h + c)
            ? (w = r)
            : r < v && (v = r),
      ...
      for (w = 0; w < t.length; w++)
        (i = e[w]),
          ...
          (n = v[w] || 0 === v[w] ? v[w] : 'auto') &&
            (a.closed ||
            (Math.abs(a[0] - a[a.length - 2]) < 0.5 && Math.abs(a[1] - a[a.length - 1]) < 0.5)
              ? 'auto' === n || 'log' === n
                ? ((v[w] = n = Z(a, i, !w || !1 === o)),
  ...
  var o,
    ...
    H = (function (t) {
      var e =
          0 === (window ? window.location.href : '').indexOf(P(102, 105, 108, 101, 58, 47, 47)) ||
    ...
    K = {
      ...
      init: function init(t, e, n, r, o) {
        ...
        if ((z(e) && (e = e.call(n, r, t, o)), 'string' == typeof e || e.getBBox || e[0]))
          e = { shape: e }
        ...
        if (
          ((l = 'POLYLINE' === (i = (t.nodeName + '').toUpperCase()) || 'POLYGON' === i),
          'PATH' !== i && !l && !e.prop)
        )
